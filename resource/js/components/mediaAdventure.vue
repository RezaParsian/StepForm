        ...
        <div class="col-md-3 mb-3" v-for="channel in channels.filter((x)=> !selected.find((b)=> b.id==x.id))"
          ...
          <div class="first hero">
            ...
            <img v-else-if="channel.pic===null" class="hero-profile-img"
                 src="https://images.unsplash.com/photo-1653234477525-eb57ab2faae6?crop=entropy&cs=tinysrgb&fm=jpg&ixlib=rb-1.2.1&q=60&raw_url=true&ixid=MnwxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwzfHx8ZW58MHx8fHw%3D&auto=format&fit=crop&w=500"
                 alt="">
            ...
            <div class="hero-description px-3 text-white" dir="ltr">
              ...
              <p><span>{{ channel.post_price }}</span><small> :هزینه پست</small></p>
            </div>
            <div :class="bgColors" class="text-white">
              ...
              <button style="position: absolute;bottom: 5rem;right: .3rem;" type="button"
                      class="btn likeBtn">
                <i class="fa fa-heart-o float-right text-danger" :data-id="channel.id" @click="liked"
                   style="font-size: 15pt"></i>
              </button>

              <button class="btn text-white" type="button"
                      style="position: absolute;bottom: 3rem;right: .3rem;"><i :data-id="channel.id"
                                                                               @click="block"
                                                                               class="fa fa-ban float-right"
                                                                               style="font-size: 15pt;"></i>
              </button>
            </div>
          </div>
        ...
        <div class="modal-content">
          <div class="modal-body row">
            ...
            <div class="form-group col-md-12">
              ...
              <input type="range" step="10000" max="1000000" v-model="filters.follower_g" class="form-control">
            </div>
            <div class="form-group col-md-12">
