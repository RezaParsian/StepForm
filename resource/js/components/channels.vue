<template>
  <div id="vue_channels" style="max-height: 50rem;overflow: auto;">

    <div id="postPrice" class="doubleRange">
      <div class="barre">
      ...
      <input type="hidden" name="pmin" v-model="postPrice_l" value="" class="inputMin"/>
      <input type="hidden" name="pmax" value="" v-model="postPrice_g" class="inputMax"/>
    </div>
    <div id="follower" class="doubleRange">
      <div class="barre">
        <div class="barreMilieu" style="width:50%; left:25%;"></div>
        <div class="t1 thumb" style="left:25%"></div>
        <div class="t2 thumb" style="left:75%;"></div>
    ...
    <div id="storyPrice" class="doubleRange">
      <div class="barre">
        <div class="barreMilieu" style="width:50%; left:25%;"></div>
        <div class="t1 thumb" style="left:25%"></div>
        <div class="t2 thumb" style="left:75%;"></div>
...
<script>
import setDoubleRange from "../custom";
export default {
  name: "channels",
  props: {
    province: {
  ...
  mounted() {
    ...
    setDoubleRange({
      element: '#follower',
      minValue: this.minFollower,
      maxValue: this.maxFollower,
      maxInfinite: true,
      stepValue: 1000,
      defaultMinValue: 500,
      defaultMaxValue: 10000,
      onChange: (data) => {
        this.minFollower = data.minValue;
        this.maxFollower = data.maxValue;
      }
    });
    setDoubleRange({
      element: '#storyPrice',
      minValue: this.storyPrice_l,
      maxValue: this.storyPrice_g,
      maxInfinite: true,
      stepValue: 1000,
      defaultMinValue: 500,
      defaultMaxValue: 10000,
